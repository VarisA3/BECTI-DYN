...
//--- Infantry
_c = _c + ['B_Soldier_SL_F']; //This unit for PvP Reward
_p = _p + [''];
_n = _n + [''];
_o = _o + [2000];
_t = _t + [5];
...
_c = _c + ['B_AFV_Wheeled_01_cannon_F'];
_p = _p + [''];
_n = _n + [''];
_o = _o + [9000];
_t = _t + [30];
...
_c = _c + ['B_AFV_Wheeled_01_up_cannon_F'];
_p = _p + [''];
_n = _n + [''];
_o = _o + [10000];
_t = _t + [30];
...
_c = _c + ['B_T_APC_Tracked_01_AA_F'];
_p = _p + [''];
_n = _n + ['IFV-6h Cheetah H-type'];
_o = _o + [4500];
_t = _t + [30];
_u = _u + [0];
_f = _f + [CTI_FACTORY_HEAVY];
...
_c = _c + ['B_Heli_Attack_01_dynamicLoadout_F'];
_p = _p + [''];
_n = _n + [''];
_o = _o + [4000];
_t = _t + [50];
